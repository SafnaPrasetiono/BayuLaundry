    ...
    <div class="wrapper">
        ...
        <div class="slider shadow" id="sliderExample">
            <div class="slider-head">
                <div class="slider-profile-image mb-2" style="background-image: url('/images/admins/{{auth('admins')->user()->avatar}}')"></div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('admin.logout') }}" class="btn btn-primary">Iya, keluar</a>
                </div>
            </div>
        </div>
    </div>
